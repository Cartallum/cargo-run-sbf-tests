...
fn run_tests(opt: Opt) -> Result<(), anyhow::Error> {
    ...
    let transaction_accounts = vec![
        (
            loader_id,
            AccountSharedData::new(0, 0, &cbe_sdk::native_loader::id()),
        ),
        (
            Pubkey::new_unique(),
    ...
    match result {
        ...
        StableResult::Err(e) => {
            ...
            //     let analysis =
            //         cbe_rbpf::static_analysis::Analysis::from_executable(executable.as_ref());
...
#[structopt(
    ...
    about = "Test runner for the sbf-cartallum-cbe target"
)]
struct Opt {
    #[allow(dead_code)]
